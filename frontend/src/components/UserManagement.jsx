...
//       setMessage({ type: 'error', text: 'Failed to load billers' });
//     } finally {
//       setLoading(false);
//     }
//   };
...
//       if (response.ok) {
//         setMessage({ type: 'success', text: 'Biller deleted successfully' });
//         setBillers(billers.filter(b => b.id !== billerId));
//       } else {
//         const data = await response.json();
//         setMessage({ type: 'error', text: data.error || 'Failed to delete biller' });
//       }
//     } catch (error) {
...
//               setMessage({ type: 'success', text: 'Biller updated successfully' });
//             } else {
...
// const BillerForm = ({ biller, onCancel, onSuccess }) => {
//   const { session } = useAuth();
//   const [formData, setFormData] = useState({
...
//       } else {
//         const data = await response.json();
//         setError(data.error || 'Failed to save biller');
//       }
//     } catch (error) {
