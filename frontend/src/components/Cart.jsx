...
const Cart = ({ isOpen, onClose, cartItems, onUpdateQuantity, onRemoveItem,calculateDiscountedPrice,session,onCheckout,isValidating}) => {
  ...
  return (
    <>
      {/* Backdrop */}
      <div 
        className="fixed inset-0 bg-black/30 backdrop-blur-md z-40  bg-opacity-30 transition-opacity"  
        onClick={onClose}
      ></div>
        ...
        {cartItems.length > 0 && (
          <div className="border-t border-gray-200 p-5 bg-white">
            ...
            <button 
              ...
              className={`w-full py-3.5 rounded-lg font-semibold text-base transition-all shadow-md hover:shadow-lg ${
                isValidating
