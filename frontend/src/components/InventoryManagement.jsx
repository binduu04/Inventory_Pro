...
// import { Plus, Edit2, Trash2, Search, Package, AlertTriangle, Upload, X, Image as ImageIcon } from 'lucide-react';
...
//                               </div>
//                               <div className="text-xs text-gray-500">Safety: {product.safety_stock}</div>
//                             </div>
//                           </td>
//                           <td className="px-6 py-4 text-sm text-gray-600">{product.season_affinity}</td>
//                           <td className="px-6 py-4">
//                             <span className={`px-2 py-1 rounded-full text-xs font-medium ${
//                               product.is_forecastable
//                                 ? 'bg-green-100 text-green-800'
//                                 : 'bg-gray-100 text-gray-800'
//                             }`}>
//                               {product.is_forecastable ? 'Yes' : 'No'}
//                             </span>
//                           </td>
...
// const ProductForm = ({ product, suppliers, categories, seasons, onCancel, onSuccess }) => {
//   const { session } = useAuth();
//   const [formData, setFormData] = useState({
//     product_name: product?.product_name || '',
//     category: product?.category || '',
//     season_affinity: product?.season_affinity || 'All Season',
...
//         !formData.safety_stock || !formData.lead_time_days) {
...
//     if (parseInt(formData.current_stock) < 0 || parseInt(formData.safety_stock) < 0) {
