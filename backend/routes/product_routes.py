...
#         # Validate season_affinity
#         valid_seasons = ['all', 'summer', 'winter', 'monsoon']
#         season = data.get('season_affinity', 'all')
...
#             'is_forecastable': data.get('is_forecastable', False),
...
#             valid_seasons = ['all', 'summer', 'winter', 'monsoon']
#             if data['season_affinity'] not in valid_seasons:
#                 return jsonify({'error': 'Invalid season'}), 400
#             update_data['season_affinity'] = data['season_affinity']
...
#             update_data['is_forecastable'] = data['is_forecastable']
